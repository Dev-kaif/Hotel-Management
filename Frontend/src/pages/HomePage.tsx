    ...
    <>
        ...
        <div className="container mx-auto px-4 relative z-10 text-white">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-200">
              Luxury dining at its finest. From gourmet dishes to comfortable ambiance, our hotel restaurant delivers exceptional culinary experiences every time.
            </p>
            <Link to="/booking">
      ...
      <Section id="about" className="bg-black">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-4xl font-bold mb-6 fancy-border pb-2">Our Story</h2>
            <p className="text-gray-300 mb-4">
              Founded in 2005, Luxe Haven started as a boutique hotel with a vision to redefine luxury hospitality. Our journey began with a passion for creating memorable experiences through exceptional service and culinary excellence.
            </p>
            <p className="text-gray-300 mb-6">
              Today, we are proud to be recognized as one of the premier luxury hotels, combining timeless elegance with modern sophistication. Our restaurant has earned accolades for its innovative cuisine that blends traditional flavors with contemporary techniques.
            </p>
            <Link to="/about">
      ...
      {/* Featured Menu Items */}
      <Section id="featured-menu" className="bg-gradient-to-b from-black to-background">
        <h2 className="section-heading fancy-border pb-2">Explore Our Latest Food Offerings</h2>
        <p className="section-subheading">
          Sample our exquisite selection of dishes prepared with the finest ingredients and culinary expertise.
        </p>
        ...
        <div className="mt-12">
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            >
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-2">Stir-Fried Rice with Meat and Veggies</h3>
                <p className="text-gray-400 mb-3">Savory fried rice with tender meat and fresh seasonal vegetables, seasoned to perfection.</p>
            ...
            >
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-2">Grilled Salmon with Herb Sauce</h3>
                <p className="text-gray-400 mb-3">Fresh Atlantic salmon, grilled to perfection and topped with our signature herb sauce.</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {menuItems.map((item, index) => (
            ...
            >
              ...
              <p className="text-sm text-gray-400 mb-3 flex-grow line-clamp-2">{item.description}</p>
              <div className="flex justify-between items-center">
                <span className="text-gold font-bold">${item.price}</span>
                <Button variant="ghost" size="sm" className="text-gold hover:bg-muted p-1 rounded-full">
      ...
      <Section id="services" className="bg-black">
        <h2 className="section-heading fancy-border pb-2">We Provide a Service That Will Exceed Your Expectations</h2>
          ...
          {services.map((service, index) => (
            ...
            >
              <Link to={service.link} className="block">
                <Button variant="outline" className="rounded-md border-gold text-gold hover:bg-gold hover:text-black w-full py-6">
                  {service.name}
                </Button>
              </Link>
            </motion.div>
      ...
      {/* Featured Dish */}
      <Section id="featured-dish" className="bg-gradient-to-b from-background to-black">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <motion.div
            initial={{ opacity: 0, x: -20 }}
            whileInView={{ opacity: 1, x: 0 }}
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-4xl font-bold mb-6">Whole Grain Bread with Avocado Dressing</h2>
            <p className="text-gray-300 mb-6">
              Our signature avocado toast combines freshly baked whole grain bread with creamy avocado, cherry tomatoes, microgreens, and a drizzle of olive oil. A perfect balance of nutrition and flavor for a satisfying meal any time of day.
            </p>
            <Link to="/menu">
              <Button className="bg-gold hover:bg-gold-dark text-black">
                Order Now
      ...
      <Section id="testimonials" className="bg-black">
        <h2 className="section-heading fancy-border pb-2">Hear from Our Customers</h2>
                  ...
                  <div className="flex">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        size={16}
                        className={i < testimonial.rating ? "text-gold fill-gold" : "text-gray-500"}
                      />
                    ))}
                  </div>
                </div>
      ...
      {/* Contact Section */}
      <Section id="contact" className="bg-gradient-to-b from-black to-background">
        <div className="grid md:grid-cols-2 gap-12">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-4xl font-bold mb-6 fancy-border pb-2">Get in Touch</h2>
            <p className="text-gray-300 mb-8">
              Have questions or want to make a special reservation? Reach out to us and our team will be delighted to assist you with any inquiries.
            </p>
...
const testimonials = [
  {
    ...
    rating: 5,
    comment: "The food was exceptional and the service impeccable. The atmosphere was perfect for our anniversary dinner."
  },
  {
    id: 2,
    ...
    rating: 5,
    comment: "Absolutely loved the seafood platter. Fresh ingredients and beautiful presentation. Will definitely return!"
  },
  {
    id: 3,
    name: "David Chen",
    ...
    rating: 4,
    comment: "Great ambiance and excellent food. The wine selection was impressive. Highly recommend the chef's special."
  }
];
